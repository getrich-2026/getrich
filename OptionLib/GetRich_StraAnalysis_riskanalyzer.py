...
class RiskAnalyzer:
    ...
    def stress_test(self, analyzer:scenario.ScenarioAnalyzer, days:int=3)->Dict:
        ...
        scenarios = {
            ...
            '动物性市场(升波暴涨)': {'price_change': 0.3, 'vol_change': 1.0}, # 情绪性上涨,价格上涨,波动率上涨
...
# results = RiskAnalyzer.stress_test(analyzer=scenario.ScenarioAnalyzer(params["positions"], params["underlying_position"], params["market_params"]))
