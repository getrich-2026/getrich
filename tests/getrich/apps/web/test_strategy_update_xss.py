...
from getrich.apps.web.errors import Forbidden, NotFound
from getrich.apps.web.services.sanitize import normalize_detail_html
from getrich.apps.web.services.strategy import update_strategy
...
async def test_update_strategy_sanitizes_detail_html(monkeypatch) -> None:
    ...
    """
    monkeypatch.setattr(
        "getrich.apps.web.services.strategy.get_strategy_detail",
...
async def test_update_strategy_normalizes_only_detail_html_key(
    ...
    # the service's call.
    monkeypatch.setattr(
        "getrich.apps.web.services.strategy.normalize_detail_html",
        spy_normalize,
    )
    monkeypatch.setattr(
        "getrich.apps.web.services.strategy.get_strategy_detail",
