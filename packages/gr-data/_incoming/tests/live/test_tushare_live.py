...
from getrich_data.raw.tushare.client import TushareProClient
from getrich_data.raw.tushare.fetchers import bars as B
from getrich_data.raw.tushare.fetchers import reference as R
...
CONTRACTS = [
    ("stock_basic", {"list_status": "L"}, R.STOCK_BASIC_FIELDS,
     {"ts_code", "name", "list_status", "list_date", "delist_date"}),
    ("index_basic", {"market": "SSE"}, R.INDEX_BASIC_FIELDS,
     {"ts_code", "name", "list_date", "exp_date"}),
    ("fut_basic", {"exchange": "SHFE", "fut_type": "1"}, R.FUT_BASIC_FIELDS,
     {"ts_code", "name", "list_date", "delist_date"}),
    ("trade_cal", {"exchange": "SSE", **DAY}, R.TRADE_CAL_FIELDS,
     {"cal_date", "is_open"}),
    ("daily", DAY, B.DAILY_FIELDS,
     {"ts_code", "trade_date", "open", "high", "low", "close", "pre_close", "vol", "amount"}),
    ("adj_factor", DAY, B.ADJ_FACTOR_FIELDS, {"ts_code", "trade_date", "adj_factor"}),
    ("stk_limit", DAY, B.STK_LIMIT_FIELDS, {"ts_code", "trade_date", "up_limit", "down_limit"}),
    ("suspend_d", DAY, B.SUSPEND_FIELDS, {"ts_code", "trade_date", "suspend_type"}),
    ("index_daily", {"ts_code": "000300.SH", **DAY}, B.INDEX_DAILY_FIELDS,
     {"ts_code", "trade_date", "open", "high", "low", "close", "pre_close", "vol", "amount"}),
    ("fut_daily", DAY, B.FUT_DAILY_FIELDS,
