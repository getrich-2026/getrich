...
def test_middleware_records_500_on_raised_exception() -> None:
    ...
    assert val == 1, f"500 response from raised exception not recorded; got {val} for /v1/error 500"
...
def test_middleware_increments_duration_histogram() -> None:
    ...
    assert count >= 1, f"duration histogram count={count} for /health; expected >= 1 after request"
