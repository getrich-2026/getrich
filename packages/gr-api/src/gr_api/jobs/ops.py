...
from gr_backtest.persistence import PgBacktestResultStore
from gr_backtest.registry import get_registry
from gr_backtest.sweep import SweepTrial
from gr_backtest.sweep_persistence import PgSweepResultStore
from gr_backtest.walk_forward import WalkForwardRunSpec
from gr_backtest.walk_forward_persistence import PgWalkForwardResultStore
...
def _build_bar_loader(kind: str) -> Any:
    ...
    from gr_backtest.data import DuckDBBarLoader, PgBarLoader
...
def _dimension_from_kind(kind: str, values: tuple[Any, ...]) -> Any:
    from gr_backtest.sweep import P
...
class WalkForwardRunOp:
    ...
    async def __call__(self, job: dict[str, Any]) -> dict[str, Any] | None:
        from gr_api.schemas.backtest import WalkForwardRunRequest
