...
import pytest
from gr_api.jobs.runner import (
    BacktestJobOp,
    BacktestJobRunner,
...
def test_is_cancelled_db_probe_returns_false_when_row_not_cancelled(
    ...
    """
    monkeypatch.setattr(
        "gr_api.jobs.persistence.sync_is_cancelled_status",
...
def test_op_failure_with_terminal_error_skips_retry() -> None:
    ...
    from gr_backtest.exceptions import TerminalError  # noqa: PLC0415
...
def test_op_failure_with_backtest_job_error_subclass_skips_retry() -> None:
    ...
    class _ValidationOp:
        async def __call__(self, job: dict[str, Any]) -> dict[str, Any] | None:
            from gr_signal.errors import BacktestJobError  # noqa: PLC0415
...
def test_op_failure_with_retryable_error_uses_default_path() -> None:
    ...
    class _BlipOp:
        async def __call__(self, job: dict[str, Any]) -> dict[str, Any] | None:
            from gr_backtest.exceptions import RetryableError  # noqa: PLC0415
