...
import polars as pl
import pytest
from gr_backtest import DEFAULT_ASHARE_SESSIONS, Session, get_shanghai_tz
from gr_backtest.strategy.context import HistoryView
from gr_signal import LiveDataError, LiveDataProvider
...
class TestLoadLatestFactors:
    ...
    def test_query_error_returns_empty_dict_with_warning(self, caplog) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="gr_signal.live_data_provider"):
            result = provider.load_latest_factors(["A"], ["mom20"])
