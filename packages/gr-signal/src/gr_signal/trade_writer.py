...
from gr_signal.errors import SignalWriteError
...
class BacktestTradeWriter:
    ...
    :func:`gr_backtest.attribution.compute_trade_journal` so that
    ...
    def _build_params(
        ...
        :func:`gr_backtest.attribution.compute_trade_journal`.
