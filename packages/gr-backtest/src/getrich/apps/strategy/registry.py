...
Supports two sources:
  1. Built-in strategies from ``getrich_backtest.strategies`` (auto-discovered)
...
from getrich.apps.strategy.errors import StrategyRegistryError
from getrich_backtest.strategies import BollingerMeanReversion, MACross
...
class StrategyRegistry:
    ...
    def _init_builtins(self) -> None:
        """Register built-in strategies from getrich_backtest.strategies."""
