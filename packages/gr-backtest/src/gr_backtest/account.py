...
from gr_backtest.exceptions import AccountError, CorporateActionError
from gr_backtest.strategy.context import AccountView, PositionView
from gr_backtest.time import require_shanghai_aware
from gr_backtest.types import AssetClass, Side
...
class Account:
    ...
    def force_close_position(
        ...
        from gr_backtest.execution import Fill  # noqa: PLC0415
    ...
    def _apply_buy_margin(self, fill: Fill, position: Position) -> None:
        ...
        from gr_backtest.margin import MarginCalculator  # noqa: F811
