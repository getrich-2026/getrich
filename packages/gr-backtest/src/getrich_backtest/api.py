...
from getrich_backtest.account import (
    Account,
    Position,
    daily_settle,
    get_settlement_prices,
)
from getrich_backtest.calendar import Calendar, Session
from getrich_backtest.cost import FeeModel, SlippageModel
from getrich_backtest.data import (
    BarLoader,
    DataFrameBarLoader,
    DuckDBBarLoader,
    PgBarLoader,
...
from getrich_backtest.data.resample import resample_bars
...
from getrich_backtest.execution import Fill, NextBarMatchingModel, Order, OrderStatus
from getrich_backtest.margin import MarginCalculator
from getrich_backtest.result import BacktestResult, CombinedResult
from getrich_backtest.risk import LiquidationEvent, RiskConfig, RiskManager
...
from getrich_backtest.time import (
    ensure_shanghai_aware,
    get_shanghai_tz,
    normalize_datetime_range,
    require_shanghai_aware,
)
from getrich_backtest.types import (
    FREQ_TO_MINUTES,
    AssetClass,
    Exchange,
    Frequency,
...
class Backtest:
    ...
    def _run_multi(self) -> CombinedResult:
        ...
        from getrich_backtest.strategy import PositionView
    ...
    def _load_or_build_calendar(self) -> Calendar | None:
        ...
        if not trading_days:
            return None
        from getrich_backtest.calendar import Calendar
