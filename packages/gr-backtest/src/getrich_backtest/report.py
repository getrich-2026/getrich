...
from getrich_backtest.attribution import (
    FactorRegResult,
...
from getrich_backtest.benchmark import BenchmarkCompareResult
...
def _plot_monthly_heatmap(equity_curve: pl.DataFrame) -> str:
    ...
    from getrich_backtest.metrics import monthly_returns_heatmap
