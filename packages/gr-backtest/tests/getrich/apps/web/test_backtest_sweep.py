...
from getrich.apps.web.services.backtest_sweep import (
    _dt,
    _dt_nullable,
    _f,
    _f_nullable,
...
class TestCrossFormatterConsistency:
    ...
    def test_summary_contains_all_sweep_columns(self) -> None:
        ...
        expected_keys = {
            "sweep_id", "search_type", "search_spec", "select_metric",
            "maximize", "status", "total_trials", "completed_trials",
            "failed_trials", "best_trial_id", "best_run_id",
            "best_metric_value", "created_at", "completed_at", "updated_at",
        }
