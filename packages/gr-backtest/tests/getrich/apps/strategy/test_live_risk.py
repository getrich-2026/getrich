...
from getrich.apps.strategy.live_runner import LiveSignalRunner, _extract_last_prices
...
from getrich_backtest.strategy import Strategy
...
class TestLoggingAlertChannel:
    def test_sends_warning_alert_to_logger(self) -> None:
        ...
        from getrich.apps.strategy.live_risk import RiskAlert
...
class TestWebhookAlertChannelSend:
    ...
    def test_failure_is_logged_not_raised(self) -> None:
        ...
        with (
            ...
            _capture_logs("getrich.apps.strategy.live_risk.webhook", logging.WARNING) as records,
        ):
            import asyncio
...
class TestWebhookAlertChannelProtocol:
    ...
    def test_satisfies_protocol(self) -> None:
        from getrich.apps.strategy.live_risk import AlertChannel
...
class TestEmailAlertChannelSend:
    ...
    def test_failure_is_logged_not_raised(self) -> None:
        ...
        with (
            ...
            _capture_logs("getrich.apps.strategy.live_risk.email", logging.WARNING) as records,
        ):
            import asyncio
