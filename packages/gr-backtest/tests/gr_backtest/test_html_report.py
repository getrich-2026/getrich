...
from gr_backtest.strategy.context import AccountView
...
def _make_benchmark_compare() -> object:
    ...
    from gr_backtest import BenchmarkCompareResult
...
class TestTearSheetAttribution:
    def test_cost_attribution_in_html(self) -> None:
        ...
        from gr_backtest import compute_cost_attribution
    ...
    def test_pnl_attribution_in_html(self) -> None:
        ...
        from gr_backtest import compute_pnl_attribution
    ...
    def test_trade_log_in_html(self) -> None:
        ...
        from gr_backtest import compute_trade_journal
