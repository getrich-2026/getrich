...
from pyecharts.charts import Bar, Line, Scatter3D  # 可视化
        ...
        scatter = (
            ...
            .set_global_opts(
                ...
                visualmap_opts=opts.VisualMapOpts(
                    max_=max(df["pnl"]), min_=min(df["pnl"]), range_color=Faker.visual_color
                ),
            )
        )
        return scatter
...
# line = Visualizer.plot_var_distribution(
#     df["pnl"], var=RiskAnalyzer.calculate_var(df["pnl"], confidence_level=0.95)
# )
