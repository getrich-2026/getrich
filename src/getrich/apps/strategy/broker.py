...
class OrderIntent:
    ...
    Mirrors the shape of :class:`getrich_backtest.execution.OrderIntent`
    ...
    async def connect(self) -> None:
        async with self._lock:
            ...
            logger.info(
                ...
                self._front_address, self._broker_id, self._user_id,
            )
...
class XtpAdapter:
    ...
    def __init__(self, client_key: str = "", account: str = "",
                 password: str = "", account_type: str = "NORMAL") -> None:
