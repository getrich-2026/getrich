import pandas as pd
import pytest
from src.utils import (  # pyright: ignore[reportImplicitRelativeImport]
    last_index_date,
    read_parquet_index,
    write_parquet,
)
...
def test_read_parquet_index_and_last_date(temp_dir):
    ...
    if df_loaded_dt is None:
        pytest.fail("df_loaded_dt is None")
    ...
    if df_loaded_int is None:
        pytest.fail("df_loaded_int is None")
