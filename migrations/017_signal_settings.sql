...
CREATE TABLE IF NOT EXISTS frontend.user_signal_settings (
...
CREATE TABLE IF NOT EXISTS frontend.user_strategy_signal_settings (
...
COMMENT ON TABLE frontend.user_signal_settings IS
    'Per-user global signal notification preferences.';
COMMENT ON TABLE frontend.user_strategy_signal_settings IS
