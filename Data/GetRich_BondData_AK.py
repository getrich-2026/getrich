...
def get_convertible_bond_history_minute(symbol, period, adjust, start_date, end_date):
    ...
    """
    df = ak.bond_zh_hs_cov_min(symbol=symbol, period=period, adjust=adjust, start_date=start_date, end_date=end_date)
    return df
...
# if __name__ == '__main__':
    ...
    # print(get_convertible_bond_history_minute(symbol='sz123124', period='5', adjust='', start_date='2025-08-01 09:32:00', end_date='2025-08-01 15:00:00'))
